...
const inviteCodes = [
  `S5KkcRBoZ81WGchrykv8KdQ@S5KkcR0sa_AGBdBv3xvdfdA`,
  `SaU7cmKSYIdxR94JJQ32PoSP5vCp8@S5KkcR0sa_AGBdBv3xvdfdA`,
  `SaU7cmKSYIdxR94JJQ32PoSP5vCp8@S5KkcRBoZ81WGchrykv8KdQ`
]
!(async () => {
  $.tuanList = []
  await requireConfig();
